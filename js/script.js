class Tooltip extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      ...
      this.props.useClick ? React.createElement(
        'span',
        { style: { color: 'blue' },
          onClick: this.toggle },
        this.props.children
        ...
        'span',
        { style: { color: 'blue' }, onMouseEnter: this.toggle,
          onMouseOut: this.toggle },
        this.props.children
      ),
      React.createElement(
        'div',
        { className: this.props.above ? "tooltip top" : "tooltip bottom", style: style, role: 'tooltip' },
...
ReactDOM.render(React.createElement(
  ...
  React.createElement(
    Tooltip,
    { useClick: true, above: true, offset: 80, text: 'Master Express.js-The Node.js Framework For Your Web Development' },
    'Pro Express.js'
  ),
  ...
  React.createElement(
    Tooltip,
    { above: true, text: 'HTTP API server' },
    'Hapi'
  ),
  ', ',
  React.createElement(
